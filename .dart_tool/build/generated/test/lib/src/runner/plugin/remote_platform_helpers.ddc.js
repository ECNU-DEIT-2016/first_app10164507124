define(['dart_sdk', 'packages/stream_channel/stream_channel', 'packages/async/async', 'packages/term_glyph/term_glyph', 'packages/test/src/backend/closed_exception', 'packages/test/test'], function(dart_sdk, stream_channel, async, term_glyph, closed_exception, test) {
  'use strict';
