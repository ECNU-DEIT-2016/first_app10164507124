define(['dart_sdk', 'packages/first_app/app_component1.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/first_app/src/Random_Generator/R_G_component', 'packages/first_app/app_component1', 'packages/angular/angular.template', 'packages/angular/core.template', 'packages/angular_components/material_button/material_fab.template', 'packages/angular_components/material_button/material_fab', 'packages/angular_components/material_icon/material_icon.template', 'packages/angular_components/material_icon/material_icon', 'packages/angular_components/material_checkbox/material_checkbox.template', 'packages/angular_components/material_checkbox/material_checkbox', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/angular_components.template'], function(dart_sdk, app_component1$46css, view_type, change_detection, modules, R_G_component, app_component1, angular, core, material_fab, material_fab$, material_icon, material_icon$, material_checkbox, material_checkbox$, has_disabled, angular_components) {
  ...
  const app_component1$46css$46shim = app_component1$46css.app_component1$46css$46shim;
  ...
  const app_component1$ = app_component1.app_component1;
  ...
  const app_component1$46template = Object.create(_root);
  ...
  let ComponentRefOfAppComponent2 = () => (ComponentRefOfAppComponent2 = dart.constFn(src__core__linker__component_factory.ComponentRef$(app_component1$.AppComponent2)))();
  let AppViewOfAppComponent2 = () => (AppViewOfAppComponent2 = dart.constFn(src__core__linker__app_view.AppView$(app_component1$.AppComponent2)))();
  let AppViewAndintToAppViewOfAppComponent2 = () => (AppViewAndintToAppViewOfAppComponent2 = dart.constFn(dart.fnType(AppViewOfAppComponent2(), [src__core__linker__app_view.AppView, core$.int])))();
  let ComponentFactoryOfAppComponent2 = () => (ComponentFactoryOfAppComponent2 = dart.constFn(src__core__linker__component_factory.ComponentFactory$(app_component1$.AppComponent2)))();
  ...
  dart.defineLazy(app_component1$46template, {
    /*app_component1$46template.styles$AppComponent2*/get styles$AppComponent2() {
      return [app_component1$46css$46shim.styles];
    }
  });
  ...
  let const$;
  app_component1$46template.ViewAppComponent20 = class ViewAppComponent20 extends src__core__linker__app_view.AppView$(app_component1$.AppComponent2) {
    build() {
  ...
  (app_component1$46template.ViewAppComponent20.new = function(parentView, parentIndex) {
    this[_el_0] = null;
    this[_el_2] = null;
    this[_compView_2] = null;
    this[_TodoListService_2_5] = null;
    this[_RGComponent_2_6] = null;
    app_component1$46template.ViewAppComponent20.__proto__.new.call(this, src__core__linker__view_type.ViewType.component, new (IdentityMapOfString$dynamic()).new(), parentView, parentIndex, src__core__change_detection__constants.ChangeDetectionStrategy.CheckAlways);
    this.rootEl = html.HtmlElement._check(html.document[$createElement]("my-app2"));
    let t = app_component1$46template.ViewAppComponent20._renderType;
    t == null ? app_component1$46template.ViewAppComponent20._renderType = src__core__linker__app_view_utils.appViewUtils.createRenderType(dart.test(src__runtime__optimizations.isDevMode) ? "asset:first_app/lib/app_component1.dart" : null, src__core__metadata__view.ViewEncapsulation.Emulated, app_component1$46template.styles$AppComponent2) : t;
    this.setupComponentType(app_component1$46template.ViewAppComponent20._renderType);
  }).prototype = app_component1$46template.ViewAppComponent20.prototype;
  dart.addTypeTests(app_component1$46template.ViewAppComponent20);
  dart.setMethodSignature(app_component1$46template.ViewAppComponent20, () => ({
    __proto__: dart.getMethods(app_component1$46template.ViewAppComponent20.__proto__),
    build: dart.fnType(src__core__linker__component_factory.ComponentRef$(app_component1$.AppComponent2), []),
    injectorGetInternal: dart.fnType(dart.dynamic, [dart.dynamic, core$.int, dart.dynamic]),
    detectChangesInternal: dart.fnType(dart.void, []),
    destroyInternal: dart.fnType(dart.void, [])
  }));
  dart.setFieldSignature(app_component1$46template.ViewAppComponent20, () => ({
    __proto__: dart.getFields(app_component1$46template.ViewAppComponent20.__proto__),
  ...
  dart.defineLazy(app_component1$46template.ViewAppComponent20, {
    /*app_component1$46template.ViewAppComponent20._renderType*/get _renderType() {
      return null;
    },
    set _renderType(_) {}
  });
  app_component1$46template.viewFactory_AppComponent20 = function(parentView, parentIndex) {
    return new app_component1$46template.ViewAppComponent20.new(parentView, parentIndex);
  };
  dart.defineLazy(app_component1$46template, {
    /*app_component1$46template.styles$AppComponent2Host*/get styles$AppComponent2Host() {
      return dart.constList([], dart.dynamic);
    }
  });
  const _compView_0 = Symbol('_compView_0');
  const _AppComponent2_0_5 = Symbol('_AppComponent2_0_5');
  app_component1$46template._ViewAppComponent2Host0 = class _ViewAppComponent2Host0 extends src__core__linker__app_view.AppView$(app_component1$.AppComponent2) {
    build() {
      this[_compView_0] = new app_component1$46template.ViewAppComponent20.new(this, 0);
      this.rootEl = this[_compView_0].rootEl;
      this[_AppComponent2_0_5] = new app_component1$.AppComponent2.new();
      this[_compView_0].create(this[_AppComponent2_0_5], this.projectableNodes);
      this.init0(this.rootEl);
      return new (ComponentRefOfAppComponent2()).new(0, this, this.rootEl, this[_AppComponent2_0_5]);
    }
    detectChangesInternal() {
  ...
  (app_component1$46template._ViewAppComponent2Host0.new = function(parentView, parentIndex) {
    this[_compView_0] = null;
    this[_AppComponent2_0_5] = null;
    app_component1$46template._ViewAppComponent2Host0.__proto__.new.call(this, src__core__linker__view_type.ViewType.host, new (IdentityMapOfString$dynamic()).new(), parentView, parentIndex, src__core__change_detection__constants.ChangeDetectionStrategy.CheckAlways);
  }).prototype = app_component1$46template._ViewAppComponent2Host0.prototype;
  dart.addTypeTests(app_component1$46template._ViewAppComponent2Host0);
  dart.setMethodSignature(app_component1$46template._ViewAppComponent2Host0, () => ({
    __proto__: dart.getMethods(app_component1$46template._ViewAppComponent2Host0.__proto__),
    build: dart.fnType(src__core__linker__component_factory.ComponentRef$(app_component1$.AppComponent2), []),
    detectChangesInternal: dart.fnType(dart.void, []),
    destroyInternal: dart.fnType(dart.void, [])
  }));
  dart.setFieldSignature(app_component1$46template._ViewAppComponent2Host0, () => ({
    __proto__: dart.getFields(app_component1$46template._ViewAppComponent2Host0.__proto__),
    [_compView_0]: dart.fieldType(app_component1$46template.ViewAppComponent20),
    [_AppComponent2_0_5]: dart.fieldType(app_component1$.AppComponent2)
  }));
  app_component1$46template.viewFactory_AppComponent2Host0 = function(parentView, parentIndex) {
    return new app_component1$46template._ViewAppComponent2Host0.new(parentView, parentIndex);
  };
  dart.defineLazy(app_component1$46template, {
    /*app_component1$46template._AppComponent2NgFactory*/get _AppComponent2NgFactory() {
      return dart.const(new (ComponentFactoryOfAppComponent2()).new("my-app2", dart.fn(app_component1$46template.viewFactory_AppComponent2Host0, AppViewAndintToAppViewOfAppComponent2())));
    }
  });
  dart.copyProperties(app_component1$46template, {
    get AppComponent2NgFactory() {
      return app_component1$46template._AppComponent2NgFactory;
    }
  });
  dart.defineLazy(app_component1$46template, {
    /*app_component1$46template._visited*/get _visited() {
      return false;
    },
    set _visited(_) {}
  });
  app_component1$46template.initReflector = function() {
    if (dart.test(app_component1$46template._visited)) {
      return;
    }
    app_component1$46template._visited = true;
    src__di__reflector.registerComponent(dart.wrapType(app_component1$.AppComponent2), app_component1$46template.AppComponent2NgFactory);
  ...
  dart.trackLibraries("packages/first_app/app_component1.template.ddc", {
    "package:first_app/app_component1.template.dart": app_component1$46template,
...
//# sourceMappingURL=app_component1.template.ddc.js.map
